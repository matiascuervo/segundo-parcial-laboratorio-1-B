...
personaje = Personaje(H/2 - 300, 450, 0, 10,[personaje_camina,
                   ...
                   personaje_ataque_izquierda],20,10,personaje_daño)
...
while True:
    ...
    personaje.recibir_daño_heroe(50, lista_enemigos, planta_enemigo.lista_proyectiles_enemigo)
    personaje.recibir_daño_heroe(50, lista_enemigos, planta_enemigo_2.lista_proyectiles_enemigo)
